// Hongda Core owns its protocol, routing and control-plane implementation. It
// does not import sing-box or mihomo; Windows TUN uses the separately disclosed
// sing-tun, gVisor and Wintun components.
package main
...
const (
	version        = "1.10.0"
	featureSummary = "direct,vless,trojan,hysteria2,tuic,reality,utls,ws,grpc,vless-vision,vless-xudp,rules,remote-rule-set,rule-set-cache,doh,dns-hijack,tcp-dns-hijack,dns-rule-reject,udp-associate,udp-proxy,mixed,socks5,http-connect,tun,wintun,gvisor,strict-route,interface-bind,clash-api"
)
