...
const (
	version        = "1.8.0"
	featureSummary = "direct,vless,trojan,hysteria2,tuic,reality,utls,ws,grpc,vless-vision,vless-xudp,mux,rules,doh,udp-associate,udp-proxy,mixed,socks5,http,clash-api,ipc"
)
