...
const (
	version        = "1.8.1"
	featureSummary = "direct,vless,trojan,hysteria2,tuic,reality,utls,ws,grpc,vless-vision,vless-xudp,rules,doh,udp-associate,udp-proxy,mixed,socks5,http-connect,clash-api"
)
