...
const (
	version        = "1.9.0-rc.1"
	featureSummary = "direct,vless,trojan,hysteria2,tuic,reality,utls,ws,grpc,vless-vision,vless-xudp,rules,doh,dns-hijack,udp-associate,udp-proxy,mixed,socks5,http-connect,tun,wintun,gvisor,strict-route,clash-api"
)
