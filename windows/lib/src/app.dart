      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            OutlinedButton.icon(
              onPressed: () =>
                  WindowsIntegration.openFolder(storage.baseDir.path),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.2。'
