      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              widget.controller.isRunning
                  ? '已连接时使用 HongdaCore 控制 API 做真实代理 URLTest；未连接时只检查 TCP 端口可达，不把 TCP 建连时间冒充代理延迟。'
                  : '当前未连接：只检查 TCP 端口可达；连接后可得到真实代理 URLTest 延迟。',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.8。'
