        ...
        _SettingsCard(
          ...
          children: <Widget>[
            _SettingSwitch(
              ...
              subtitle:
                  '由 sing-box Tailscale endpoint 创建 HongdaTail 系统接口；需要管理员权限',
              value: settings.tailscaleEnabled,
              enabled: !isRunning,
              onChanged: (v) {
                settings.tailscaleEnabled = v;
                onChanged();
              },
            ),
            if (settings.tailscaleEnabled) ...<Widget>[
              ...
              _StringSetting(
                ...
                onChanged: (v) {
                  settings.tailscaleControlUrl = v;
                  onChanged();
                },
              ),
              _SettingSwitch(
                ...
                enabled: !isRunning,
                onChanged: (v) {
                  settings.tailscaleAcceptRoutes = v;
                  onChanged();
                },
              ),
              _StringSetting(
              ...
              _SettingSwitch(
                ...
                enabled: !isRunning,
                onChanged: (v) {
                  settings.tailscaleExitNodeAllowLanAccess = v;
                  onChanged();
                },
              ),
            ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              widget.controller.isRunning
                  ? '已连接时使用 sing-box Clash API 做真实代理 URLTest；未连接时只检查 TCP 端口可达，不把 TCP 建连时间冒充代理延迟。'
        ...
        _ToolbarCard(
          child: Row(
            children: <Widget>[
              Expanded(
                child: Text(
                  '${widget.groups.length} 个规则组 · Selector / URLTest 可直接写入 sing-box 运行配置',
                  style: const TextStyle(
                    fontSize: 10.8,
                    color: Color(0xFF667085),
                  ),
        ...
        _ToolbarCard(
          child: Row(
            children: <Widget>[
              Expanded(
                child: Text(
                  '${widget.rules.length} 条路由规则 · 支持域名、后缀、关键词、CIDR、进程名和 TCP/UDP',
                  style: const TextStyle(
                    fontSize: 10.8,
                    color: Color(0xFF667085),
                  ),
            ...
            child: controller.logs.isEmpty
                ? const Center(
                    child: _EmptyState(
                      ...
                      title: '暂无日志',
                      subtitle: '启动连接后，这里显示 sing-box 标准输出和错误信息。',
                    ),
                  )
                : ListView.builder(
                    reverse: true,
