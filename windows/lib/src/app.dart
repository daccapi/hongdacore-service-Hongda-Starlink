...
class _MainShellState extends State<MainShell> {
  ...
  Future<void> _selectNode(NodeProfile node) async {
    ...
    if (settings.selectedNodeId == node.id && !controller.isRunning) return;
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(fontSize: 9, color: Color(0xFF7B8798)),
                      ),
                    ],
                  ),
                ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.0。'
