            ...
            builder: (context, child) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: const Color(0xFF1677FF).withOpacity(glow),
                      blurRadius: 22,
                      spreadRadius: 2,
                    ),
                  ],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.3。'
    ...
    children: <Widget>[
      ...
      if (actionText != null)
        TextButton(
          ...
          child: Text(actionText!, style: const TextStyle(fontSize: 10.5)),
        ),
    ],
  );
}
  ...
  switch (protocol.toLowerCase()) {
    ...
    default:
      return protocol.isEmpty
          ? '?'
          : protocol
                .substring(0, protocol.length < 2 ? protocol.length : 2)
                .toUpperCase();
  }
}
