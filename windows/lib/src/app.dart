...
class AppBootstrap {
  ...
  static Future<AppBootstrap> create() async {
    ...
    if (settings.windowsTunProfileVersion < 5) {
      ...
      settings.windowsTunProfileVersion = 5;
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 3),
                      Text(
                        '智能分流采用 Karing 式选择性代理：自定义规则优先，国内直连，OpenAI 内置规则 / GFW 列表走节点，未命中流量直连。',
                        style: TextStyle(
                          fontSize: 9.6,
                          color: Color(0xFF667085),
                          height: 1.4,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.5。'
