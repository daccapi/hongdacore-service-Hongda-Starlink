  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final wide = width >= (constraints.maxHeight < 820 ? 760 : 940);
        ...
        final nodeCard = _DashboardNodeCard(
          ...
          maxRows: ultraDense ? 2 : (dense ? 3 : 5),
          dense: dense,
        );
        ...
        builder: (context, constraints) {
          ...
          final mainContent = roomy
              ? Row(
                  children: <Widget>[
                    SizedBox(
                      width: constraints.maxWidth < 900 ? 285 : 360,
                      child: status,
                    ),
                    const SizedBox(width: 18),
...
class _HeroMetric extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: dense ? 72 : 92,
      padding: EdgeInsets.fromLTRB(12, dense ? 7 : 10, 12, dense ? 5 : 7),
      decoration: BoxDecoration(
...
class _QuickActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Card(
    child: Padding(
      padding: EdgeInsets.fromLTRB(14, dense ? 8 : 11, 14, dense ? 8 : 11),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          const Text(
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              return GridView.count(
                crossAxisCount: 2,
                childAspectRatio: dense ? 4.2 : 3.1,
