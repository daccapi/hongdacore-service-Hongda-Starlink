...
class AppBootstrap {
  ...
  static Future<AppBootstrap> create() async {
    ...
    if (settings.windowsTunProfileVersion < 3) {
      ...
      // will fail even though ordinary browsers appear healthy. Use a full
      // dual-stack TUN and strict routing so those applications are captured.
      ...
      settings.windowsTunProfileVersion = 3;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  coreVersion == null
                      ? '鸿达星轨智连 Windows 桌面网络连接工具。当前源码包已包含 HongdaService.exe，并内嵌 HongdaCore 1.10.1。'
