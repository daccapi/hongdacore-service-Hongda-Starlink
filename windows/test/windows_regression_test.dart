...
void main() {
  ...
  test(
    'builds stable Windows IPv4 split routes without rejecting TUN peer',
    () {
      ...
      expect(tun['address'], <String>['172.19.0.1/30']);
      expect(tun['route_address'], <String>['0.0.0.0/1', '128.0.0.0/1']);
      expect(
