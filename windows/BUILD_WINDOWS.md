...
运行时释放到 `%LOCALAPPDATA%\HongdaStarlink\runtime\1.10.4\`，执行配置与远程规则集检查，再把 Core 加入 kill-on-close Windows Job Object。
...
```text
..\Hongda-Starlink-V1.6.16-Windows-x64.zip
```
