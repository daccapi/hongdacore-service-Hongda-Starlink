...
运行时释放到 `%LOCALAPPDATA%\HongdaStarlink\runtime\1.10.11\`，执行配置与远程规则集检查，再把 Core 加入 kill-on-close Windows Job Object。
...
# 构建并验证 HongdaService.exe 1.5.11
...
```text
..\Hongda-Starlink-V1.6.24-Windows-x64.zip
```
