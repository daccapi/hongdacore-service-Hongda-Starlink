...
const featureSummary = "direct,vless,trojan,hysteria2,tuic,reality,remote-rule-set,rule-set-cache,doh,dns-hijack,tcp-dns-hijack,dns-rule-reject,dns-route-cache,tls-sni-sniff,tun,wintun,gvisor,interface-bind,clash-api"
