...
// It embeds the locally built HongdaCore Windows runtime and extracts it into
// the user's local application data directory on demand. HongdaCore is built
// from the vendored upstream source; upstream attribution remains in the
// accompanying third-party notices and source tree.
package main
