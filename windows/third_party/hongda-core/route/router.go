...
// TrackConnection registers a non-stream flow (currently TUN UDP) so Clash's
// connection list and DELETE /connections operate on real sockets.
...
// sing-box destination fields form one logical group: domain, suffix,
// keyword, IP CIDR and rule-set references are ORed. Network and port above
// remain AND constraints.
