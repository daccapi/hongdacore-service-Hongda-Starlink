// Package ruleset loads and matches sing-box source-format rule sets without
// importing the sing-box runtime. The supported subset intentionally matches
// the Karing ACL4SSR files used by Hongda Starlink.
package ruleset
