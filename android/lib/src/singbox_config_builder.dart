...
class SingBoxConfigBuilder {
  ...
  Map<String, dynamic> build({
    ...
    if (settings.tunEnabled) {
      // Never send packets addressed to the synthetic TUN link back through
      // the direct outbound. Windows can probe the peer address (for example
      // UDP/5351); without this guard the packet can re-enter HongdaTun and
      // look like continuous upload traffic.
      routeRules.add(<String, dynamic>{
        'ip_cidr': <String>[
          '172.19.0.0/30',
          if (settings.ipv6Enabled) 'fdfe:dcba:9876::/126',
        ],
        'action': 'reject',
      });
