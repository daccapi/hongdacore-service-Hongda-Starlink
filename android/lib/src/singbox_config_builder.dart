...
class SingBoxConfigBuilder {
  ...
  Map<String, dynamic> build({
    ...
    if (tunActive) {
      ...
      if (!androidMode) {
        routeRules.add(<String, dynamic>{
          'ip_cidr': <String>[
            '172.19.0.2/32',
            if (settings.ipv6Enabled) 'fdfe:dcba:9876::2/128',
          ],
          'action': 'reject',
        });
      }
    ...
    final dns = _buildDns(settings, androidMode: androidMode);
  ...
  Map<String, dynamic> _buildDns(AppSettings settings, {bool androidMode = false}) {
