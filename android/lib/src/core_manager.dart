...
/// Earlier versions used this name, but the executable it manages is now HongdaService.exe with the official sing-box Windows runtime embedded inside it. There is no
...
class CoreManager {
  ...
  static const String version = '1.13.18';
  static const String serviceVersion = '1.4.2';
  ...
  Future<String?> queryFeatures() async {
    ...
    if (path == null) return null;
    try {
      final result = await Process.run(path, const <String>['features'])
